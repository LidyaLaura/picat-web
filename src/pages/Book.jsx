...
function Book() {
  ...
  const handleSearch = async () => {
    ...
    const toastId = toast.loading("Mencari kategori buku...", {
      position: "bottom-center",
      theme: isDarkMode ? "light" : "dark",
    });
    ...
    try {
      const API_URL = 'https://tohpati.pythonanywhere.com/predict/book'; 
          ...
          <Box display={"flex"} gap={"5px"} >
            <Field.Root position={"relative"} height={"50px"} display={"flex"} flexDir={"row"} alignItems={"center"}>
              ...
              <Input 
                ...
                border={"none"}
                outline={"none"}
                placeholder={useTwoInput ? 'Input Title' : 'Input Title Or Synopsis'} 
          ...
          {apiResponseData && (
            ...
            >
              <Box height={"70px"} display={"flex"} width={"100%"} justifyContent={"space-around"} alignItems={"center"}>
                ...
                <Box color={isDarkMode ? "gray.300" : "gray.800"} display={"flex"} flexDir={"column"} alignItems={"center"}>
                  <Text fontSize={"22px"}>Synopsis</Text>
